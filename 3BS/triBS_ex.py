...
# -*- coding: utf-8 -*-
"""
Created on Fri Aug  6 12:29:30 2021
...
"""if d != default_d:
  ...
  #  p6.center -=delta
    ...
    for np in range(len(meio_branch)):
        meio_branch[np].center += delta
        for nv in range(len(meio_branch[np].vertices)):
            meio_branch[np].vertices[nv] += delta
 """           
